...
function Liquid:update(fieldClass, updateType, dt)
    if updateType == fieldClass.elementManager.updateTypes.MOVE then
        ...
        if not isLowerBound then
            local isDownReachable = not isLowerBound and fieldClass.field[self.y + 1][self.x] == 0
            local isDownLeftReachable = not isLowerBound and self.x - 1 > 0 and fieldClass.field[self.y + 1][self.x - 1] == 0
            local isDownRightReachable = not isLowerBound and self.x + 1 <= fieldClass.width and fieldClass.field[self.y + 1][self.x + 1] == 0
            if isDownReachable then
                ...
                for i=1,(self.gravity - gravRand) do
                    ...
                    isDownLeftReachable = not isLowerBound and self.x - 1 > 0 and fieldClass.field[self.y + 1][self.x - 1] == 0
                    isDownRightReachable = not isLowerBound and self.x + 1 <= fieldClass.width and fieldClass.field[self.y + 1][self.x + 1] == 0
                    if isLowerBound then break end
                end
            else
                local isDownLeftReachable = self.x - 1 > 0 and fieldClass.field[self.y + 1][self.x - 1] == 0
                local isDownRightReachable = self.x + 1 <= fieldClass.width and fieldClass.field[self.y + 1][self.x + 1] == 0
                ...
                if sideChoice == 0 then
                    ...
                    for i=1,self.dispersionRate do
                        ...
                        isDownReachable = self.y < fieldClass.height and fieldClass.field[self.y + 1][self.x] == 0
                        isDownLeftReachable = self.y < fieldClass.height and self.x - 1 > 0 and fieldClass.field[self.y + 1][self.x - 1] == 0
                ...
                elseif sideChoice == 1 then
                    ...
                    for i=1,self.dispersionRate do
                        ...
                        isDownReachable = self.y < fieldClass.height and fieldClass.field[self.y + 1][self.x] == 0
                        isDownRightReachable = self.y < fieldClass.height and self.x + 1 <= fieldClass.width and fieldClass.field[self.y + 1][self.x + 1] == 0
    ...
    elseif updateType == fieldClass.elementManager.updateTypes.SWAP then
        ...
        if isDownCanBeSwapped then
            ...
            elseif isDownLeftCanBeSwapped then
                ...
                fieldClass.field[self.y][self.x] = targetCellDownLeft
                fieldClass.field[self.y][self.x].isUpdated = true
                self.y, self.x = y, x
            elseif isDownRightCanBeSwapped then
                ...
                fieldClass.field[self.y][self.x] = targetCellDownRight
                fieldClass.field[self.y][self.x].isUpdated = true
                self.y, self.x = y, x
            else
